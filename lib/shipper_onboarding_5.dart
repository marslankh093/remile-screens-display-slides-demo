...
class ShipperOnboarding5Screen extends StatefulWidget {
  const ShipperOnboarding5Screen({super.key});

  @override
  State<ShipperOnboarding5Screen> createState() => _ShipperOnboarding5ScreenState();
}

class _ShipperOnboarding5ScreenState extends State<ShipperOnboarding5Screen> {
        ...
        child: SafeArea(
          ...
          child: Stack(
            children: [
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      _createFadeRoute(const ShipperOnboarding4Screen()),
                    );
                  },
                ),
              ),
              Positioned(
                ...
                child: Container(
                  ...
                  child: TweenAnimationBuilder<double>(
                    tween: Tween<double>(begin: 215 * scale, end: 268.75 * scale),
              ...
              _buildRadioOption(scale, 'Yes', 285 * scale),
              _buildRadioOption(scale, 'No', 352 * scale),
              Positioned(
                top: 625 * scale,
                left: 287 * scale,
                child: GestureDetector(
                  onTap: () {
                    if (_selectedOption != null) {
                      Navigator.push(context, _createFadeRoute(const ShipperOnboarding6Screen()));
                    } else {
